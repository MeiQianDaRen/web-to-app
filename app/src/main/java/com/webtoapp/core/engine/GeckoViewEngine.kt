    ...
    private fun buildCertificateErrorPage(errorCode: Int): String {
        val html = """
            ...
            <head>
                ...
                <style>
                    html,body{height:100%;margin:0}body{display:none;align-items:center;justify-content:center;background:#f5f7fb;font-family:system-ui,-apple-system,sans-serif}button{min-height:44px;padding:0 22px;border:0;border-radius:10px;background:#1677ff;color:#fff;font-size:16px}
                </style>
            </head>
            <body>
